...
class OnboardingStepIndicator {
  ...
  render() {
    ...
    const html = `
      <div class="onboarding-indicator" id="onboarding-indicator">
        <div class="onboarding-indicator__header">
          <span class="onboarding-indicator__title">Get Started</span>
          <button class="onboarding-indicator__dismiss" aria-label="Dismiss" title="Dismiss onboarding">
  ...
  renderResumeCTA() {
    return `
      <div class="onboarding-resume-cta" id="onboarding-resume-cta">
        <button class="onboarding-resume-btn" aria-label="Resume onboarding">

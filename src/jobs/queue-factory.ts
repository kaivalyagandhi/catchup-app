 ...
 * 
 * This factory creates queues and workers that share a single connection pool,
 * reducing Redis connections from 33 (11 queues × 3) to 1-3 total.
 * 
 * Usage:
 * ```typescript
 * // Create a queue
...
export function createQueue<T = any>(
  ...
  console.log(`[Queue Factory] Creating queue: ${name}`);
 ...
 */
export function getQueue<T = any>(name: string): Queue<T> | undefined {

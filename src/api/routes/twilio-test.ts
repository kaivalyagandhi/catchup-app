 ...
 */
router.get('/config', asyncHandler(async (req: Request, res: Response): Promise<void> => {
 ...
 */
router.get('/phone', asyncHandler(async (req: Request, res: Response): Promise<void> => {
  const accountSid = process.env.TWILIO_ACCOUNT_SID;
  const authToken = process.env.TWILIO_AUTH_TOKEN;
  const phoneNumber = process.env.TWILIO_PHONE_NUMBER;
 ...
 */
router.post('/send-sms', asyncHandler(async (req: Request, res: Response): Promise<void> => {
  const { to } = req.body;
 ...
 */
router.get('/webhook', asyncHandler(async (req: Request, res: Response): Promise<void> => {
  const accountSid = process.env.TWILIO_ACCOUNT_SID;
  const authToken = process.env.TWILIO_AUTH_TOKEN;
  const phoneNumber = process.env.TWILIO_PHONE_NUMBER;
